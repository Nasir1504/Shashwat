      ...
      <div className="card-expand-div2-mb">
        ...
        <div
          ...
          style={{
            ...
            transform: count1 === 1 && "translateY(-20vh)",
            opacity: count1 === 1 && "0",
          }}
          onMouseOver={() => {
            setTimeout(() => {
        ...
        <div
          ...
          style={{
            ...
            transform: count1 === 2 && "translateY(-20vh)",
            opacity: count1 === 2 && "0",
          }}
          onMouseOver={() => {
            setTimeout(() => {
        ...
        <div
          ...
          style={{
            ...
            transform: count1 === 3 && "translateY(-20vh)",
            opacity: count1 === 3 && "0",
          }}
          onMouseOver={() => {
            setTimeout(() => {
        ...
        <div
          ...
          style={{
            ...
            transform: count1 === 4 && "translateY(-20vh)",
            opacity: count1 === 4 && "0",
          }}
          onMouseOver={() => {
            setTimeout(() => {
        ...
        <div
          ...
          style={{
            ...
            transform: count1 === 5 && "translateY(-40vh)",
            opacity: count1 === 5 && "0",
          }}
          onMouseOver={() => {
            setTimeout(() => {
