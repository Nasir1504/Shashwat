...
export default function ComprehensiveSupport({ progress, query }) {
    ...
    return (
        <div className="comprehensive-support-main"
        //  ref={ComprehensiveSupportRef}
        >
            <section className="top-section">
                <p className="sub-heading1">Germany Awaits{query}</p>
                <h3>
                    Comprehensive Support for Every <br /> Step of Your Study Abroad Journey
                </h3>
                <p className="sub-heading2">Shashwat Sprachschule’s handholding support to turn your study abroad <br /> Dreams into reality.</p>
            ...
            {!query ?
                ...
                <section className="bottom-section"
                    style={{
                        ...
                        transform:
                            progress.Progress < 0.01 ? `translate(100%)` :
                                progress.Progress >= 0.2 && `translate(-${Math.min(35, (Math.max(0, progress.Progress * 80)))}%)`,

                        transition: progress.Progress < 0.2 && "all 2s cubic-bezier(.05,1.15,1,.99)"
                ...
                >
                    ...
                    className='inner-div'
                        style={{
                            transform: progress.Progress >= 0.2 && `translateY(-${Math.min(150, (Math.max(0, progress.Progress * 180)))}%)`,
