    ...
    return (
        <div className="why-germany-main">
            <section className="top-section">
                ...
                <p>
                    What makes Germany the ideal destination for world-class education and limitless opportunities?<br />
                    There are a plethora of reasons why it’s one of the favorite destinations of international students, some <br />
                    of which are:
                </p>
                ...
                <div className="card-slider">
                    {!query ?
                        < div className="slides"
                            style={{
                                transform: progress.Progress > 0.2 ? `translate(-${Math.min(140, (Math.max(0, progress.Progress * 180)))}%)` : ''
                        ...
                        <div className="slides"
                            style={{
                                transform: progress.Progress > 0.2 ? `translateY(-${Math.min(230, (Math.max(0, progress.Progress * 260)))}%)` : ''
        ...
        >
            ...
            >
                <div className="inner-frame">
                    ...
                    <img src={ITEM.coverImg} alt="" className="frame-img"
                        style={{
