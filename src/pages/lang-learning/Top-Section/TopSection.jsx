...
export default function TopSection({ query }) {
    return (
        <>
            {
                query ? <TopSectionMobile /> : <TopSectionPC />
            }
        </>
    )
}
...
const TopSectionPC = () => {
    return (<div className="top-section-main-pc">

        <section className="left-section">
            <img src={BluredCircle1} alt="" className="blured-circle3" />

            <p><span className="img-span"
                style={{
                    backgroundImage: `url(${textVector})`
                }}
            />
                Top Universities, Affordable Education</p>
            <h3>
                Get ready to <br />
            ...
            <p>
                Achieve your dream career in Germany with Shashwat Sprachschule. <br />
                Our expert-led language programs and consultancy services equip you <br />
...
const TopSectionMobile = () => {
    return (<div className="top-section-main-mobile">
