...
import BachelorsFrame2 from '../../../assets/imgs/language-learning/bachelors-frame2.png';
...
export default function GuideToEducation({ progress, query }) {
    ...
    return (
        <div className={!query ? "guide-to-eduction-main" : "guide-to-eduction-main-mobile"}>

            {!query ?
                <section className="left-section"
                    style={{
                        transform: progress.Progress > 0.2 && `translate(-${Math.min(100, (Math.max(0, progress.Progress * 180)))}%)`
                    }}
                >
                    <div className="heading-main">
                        <img src={GTEHeading1} alt="" className="heading-text"
                            style={{
                                opacity: trigger && '0',
                                transitionDelay: trigger && '0.88s'
                            }}
                        />
                        <img src={GTEHeading2} alt="" className="heading-text"
                            style={{
                                opacity: !trigger && '0',
                                transitionDelay: trigger && '0.88s',
                        ...
                        />
                        <img src={GTEHeading3} alt="" className="heading-text"
                            style={{
                    ...
                    <p>
                        Germany offers exceptional opportunities for students pursuing <br />
                    ...
                    <div className="btn-main">
                        <p className="bachelors">
                            ...
                            <span className="btn-span"
                                ...
                                style={{
                                    backgroundColor: degree === 0 && trigger ? '#FFC537' :
                                        degree === 1 ? '#FFC537' : '#D9D9D9',

                                    transitionDelay: degree < 1 && '0.88s'

                                }}
                            >Steps To Follow</span>
                        </p>
                        <p className="masters">
                        ...
                        < div className="cursor-icon"
                            style={{
                                ...
                                transform:
                                    degree === 0 && trigger ? `translate(8vw, 0vh)` :
                                        degree === 1 && trigger ? `translate(8vw, 0vw)` :
                                            degree === 2 && trigger ? `translate(20vw, 0vw)` : "",
                ...
                <section className="left-section"
                    style={{
                        transform: progress.Progress > 0.4 && `translate(-${Math.min(100, (Math.max(0, progress.Progress * 180)))}%)`
                    }}
                >
                    <div className="heading-main">
                        <img src={GTEHeading1} alt="" className="heading-text"
                    ...
                    <div className="btn-main">
                        ...
                        < div className="cursor-icon"
                            style={{
                                ...
                                transform:
                                    degree === 0 && trigger ? `translate(8vw, 0vh)` :
                                        degree === 1 && trigger ? `translate(18vw, 0vw)` :
                                            degree === 2 && trigger ? `translate(68vw, 0vw)` : "",
            ...
            {!query ?
                ...
                >
                    ...
                    <img src={BachelorsFrame} alt="" className="bachelor-frame"
                        style={{
                            transform: degree === 1 ? 'translateY(0%)' :
                                degree === 2 ? 'translateY(-105%)' : 'translateY(0%)',
                            opacity: degree === 1 ? '1' :
                                degree === 2 ? '0.2' : '1'
                        }}
                    />
                    <img src={BachelorsFrame} alt="" className="master-frame"
                        style={{
                ...
                >
                    ...
                    <img src={hrLine} alt="" className="hr-vector" />
                    <img src={BachelorsFrame2} alt="" className="bachelor-frame"
                        style={{
                            transform: degree === 1 ? 'translateY(0%)' :
                                degree === 2 ? 'translateY(-105%)' : 'translateY(0%)',
                            opacity: degree === 1 ? '1' :
                    ...
                    />
                    <img src={BachelorsFrame2} alt="" className="master-frame"
                        style={{
                            transform: degree === 2 ? 'translateY(-103%)' : 'translateY(0%)',
                            opacity: degree === 2 ? '1' : '0.2'
                        }}
                    />
            ...
            {!query ?
                <section className="bottom-section"
                    style={{
                        transform: progress.Progress > 0.2 && `translateY(-${Math.min(140, (Math.max(0, sValue * 200)))}%)`,
                    }}
                >
                ...
                <section className="bottom-section"
                    style={{
                        transform: progress.Progress > 0.2 && `translateY(-${Math.min(140, (Math.max(0, sValue * 280)))}%)`,
                    }}
                >
                    <img src={BottomHeading} alt="" className="bottom-heading-img" />
                    <img src={Frame1} alt="" className="frame-img" />
