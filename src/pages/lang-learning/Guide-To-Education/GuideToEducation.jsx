...
import Frame2 from "../../../assets/imgs/language-learning/img-frame2.png";

import UniversityList from "../../../assets/imgs/language-learning/university-list.png";
import UniversityList2 from "../../../assets/imgs/language-learning/university-list2.png";
...
export default function GuideToEducation({ progress, query }) {
  ...
  return (
    <div
      className={
        !query ? "guide-to-eduction-main" : "guide-to-eduction-main-mobile"
      }
    >
      {!query ? (
        <section
        ...
        <section
          ...
          style={{
            transform:
              progress.Progress > 0.2 &&
              `translate(-${Math.min(100, Math.max(0, progress.Progress * 200))}%)`,
          }}
        >
          <div className="heading-main">
            <img
          ...
          <p>
            Germany offers exceptional opportunities for students pursuing
            Bachelor's and Master's degrees. Whether you’re planning to begin
            your higher education or advance your career with a postgraduate
            degree, here’s a detailed overview:
          </p>
      ...
      {!query ? (
        ...
        <section
          ...
          style={{
            transform:
              progress.Progress > 0.2 &&
              `translateY(-${Math.min(140, Math.max(0, sValue * 220))}%)`,
          }}
        >
          <img src={BottomHeading} alt="" className="bottom-heading-img" />
          <img src={Frame2} alt="" className="frame-img" />
          <img src={UniversityList2} alt="" className="university-list-img" />
        </section>
      )}
    </div>
  );
