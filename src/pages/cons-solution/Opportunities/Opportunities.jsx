  ...
  return (
    <div className="opportunities-main">
      <section className="top-section">
        ...
        <p>
          Choose a field that suits your interests and career goals from over
          300+ Ausbildung programs, including:
        </p>
      </section>
            ...
            <div
              ...
              style={{
                transform:
                  ...
                  `translate(-${Math.min(30, Math.max(0, progress.Progress * 80))}%)`,
