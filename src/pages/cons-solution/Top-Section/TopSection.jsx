  ...
  return (
    <div className="cs-top-section-main">
      <section className="left-section">
        ...
        {!query ? (
          <p>
            ...
            <br />
            designed to build strong practical skills and is open to
            international
            <br />
          ...
          <p>
            ...
            program where you learn both in the classroom and on the job. It’s
            designed to build strong practical skills and is open to
            international students looking for career-focused education.
            <br />
            <br />
            <span className="text-span">
              <span>Shashwat Sprachschule</span> is here to guide you every step
      ...
      <section className="right-section">
        ...
        {query && (
          <div className="input-field-main-mobile">
            <input
              type="text"
              placeholder="Enter Your Email/Contact Number"
              className="input-field"
