    ...
    return (
        <div className="cs-top-section-main">
            ...
            <section className="left-section">
                ...
                <p className='main-heading'><span className="img-span"
                    style={{
                ...
                <p>
                    Germany offers Ausbildung, a unique 2–3 year vocational training<br />
                    program where you learn both in the classroom and on the job. It’s<br />
                    designed to build strong practical skills and is open to international<br />
                    students looking for career-focused education.
                    <br /><br /><br />
                    <span className="text-span">
                        <span>Shashwat Sprachschule</span> is here to guide you every step of the way.
                    </span>
                </p>
