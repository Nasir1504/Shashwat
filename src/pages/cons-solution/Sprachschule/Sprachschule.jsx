    ...
    return (
        ...
        >
            <section className="top-section">
                ...
                <p className="sub-heading">At Shashwat Sprachschule, we simplify your Ausbildung journey by providing.</p>
            ...
            <section className="bottom-section">
                <p>We’re with you at every step, ensuring a seamless transition to life and work in Germany.</p>
