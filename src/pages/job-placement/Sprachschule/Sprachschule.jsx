...
export default function Sprachschule({ progress, query }) {
    ...
    return (
        <div className={!query ? "sprachschule-main" : "sprachschule-main-mobile"}
        //  ref={SprachschuleSupportRef}
        >
            <section className="top-section">
                <p className="sub-heading1">German Language Training to Placements</p>
                <h3>
                    Shashwat Sprachschule is here to <br /> Take Care of Everything for You
                </h3>
                <p className="sub-heading2">At Shashwat Sprachschule, we offer end-to-end support to help you succeed <br /> in your nursing career in Germany. Our process includes:</p>
            ...
            {!query ?
                <section className="sprachschule-main-bottom-section"
                    style={{
                        transform: progress.Progress < 0.01 ? 'translateX(100vw)' :
                            progress.Progress > 0.1 ? `translate(-${Math.min(35, (Math.max(0, progress.Progress * 100)))}%)` : "",
                        // "translate(-35%)"

                        transition: progress.Progress < 0.5 ? "all 2s cubic-bezier(.05,1.15,1,.99)" :
                ...
                <section className="sprachschule-main-bottom-section"
                    style={{
                        transform:
                            progress.Progress < 0.01 && 'translateX(100vw)',
                ...
                >
                    <div className="inner"
                        style={{
                            transform:
                                    progress.Progress > 0.1 ? `translateY(-${Math.min(135, (Math.max(0, progress.Progress * 180)))}%)` : "",
                                // "translateY(-125%)",
                        }}
                    >
                        {
