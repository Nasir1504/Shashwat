                ...
                <div className="card-slider">
                    {!query ?
                        <div className="slides"
                            style={{
                                transform: progress.Progress > 0.2 && `translate(-${Math.min(32, (Math.max(0, progress.Progress * 80)))}%)`
                        ...
                        <div className="slides"
                            style={{
                                transform: progress.Progress > 0.2 && `translateY(-${Math.min(120, (Math.max(0, progress.Progress * 180)))}%)`
