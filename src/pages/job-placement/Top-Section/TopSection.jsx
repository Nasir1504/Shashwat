    ...
    return (
        <div className="jb-top-section-main">
            ...
            <section className="left-section">
                ...
                />
                    Join the German Healthcare System</p>
                <h3>
                    Step Into a Fulfilling<br />
                    <span>Nursing Career in Germany</span> <br />
                    with Shashwat Sprachschule<br />

                    <span className="hr-span" />

                </h3>
                <p>
                    Germany offers great opportunities in healthcare, with high demand for<br />
                    skilled nurses due to its aging population.
                    <br />
                    <br />
                    Shashwat Sprachschule is your one-stop shop for launching your<br />
