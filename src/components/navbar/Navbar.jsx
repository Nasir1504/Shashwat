...
const Navbar = ({ homeRef, heroRef }) => {
  ...
  return (
    <>
      <div
        ref={navRef}
        className="navbar fixed top-2 left-1/2 -translate-x-1/2 w-[93%] h-[70px] md:h-[80px] px-8 py-4 flex justify-between items-center rounded-3xl z-50"
      >
        ...
        {/* Desktop Menu */}
        <div className="hidden md:flex justify-center items-center gap-8 text-[#D3D3D3]">
          <a
            href="#home"
        ...
        <div className="flex flex-col gap-8 h-full mt-16">
          ...
          <div className="flex items-center gap-4 h-fit w-fit">
            <div className="relative flex items-center w-fit h-fit py-3 px-5 bg-[rgba(255,255,255,0.15)] hover:border-[1px] border-white transition-all duration-200 ease-in rounded-full">
              ...
              >
                <path
                  d="M4 4H20V20H4V4ZM2 2V22H22V2H2ZM7 7H17V9H7V7ZM7 11H17V13H7V11ZM7 15H13V17H7V15Z"
                  fill="white"
                />
              </svg>
            </div>
            <a href="/blog" className="text-xl" onClick={toggleMenu}>
              Blogs
            </a>
          </div>
        </div>
